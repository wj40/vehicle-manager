...
export function AllVehiclesTable({vehicles, searchText}: Props) {
  ...
  const filteredSortedVehicles = useMemo(() => {
      ...
      result.sort((a, b) => {
        ...
        switch (sortKey) {
          case "id":
            ...
            break
          case "brand":
            cmp = (a.brand_name ?? "").localeCompare(b.brand_name ?? "", undefined, { sensitivity: "base" })
            break
          case "model":
            cmp = (a.model_name ?? "").localeCompare(b.model_name ?? "", undefined, { sensitivity: "base" })
            break
          case "productionYear":
    ...
    return result
  }, [vehicles, filterType, filterStatus, sortKey, sortDir, searchText])
          ...
          {paginatedVehicles.map((vehicle) => {
            ...
            return (
              ...
              onClick={() => navigate(`/vehicles/${vehicle.id}`)}>
                ...
                <TableCell className="text-muted-foreground">{vehicle.model_name ?? "-"}</TableCell>
                <TableCell>
